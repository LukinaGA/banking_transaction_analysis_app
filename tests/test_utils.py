...
def test_read_excel_file_incorrect_path():
    assert read_excel_file("incorrect_path") == {}
    assert read_excel_file("operations.json") == {}
...
#     assert filter_transactions_by_date_range(transactions_info_for_utils, ["01.01.2018", "02.01.2018"]) ==
#     pd.DataFrame(
